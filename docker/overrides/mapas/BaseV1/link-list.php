    ...
    <div class="widget" ng-non-bindable>
        ...
        <?php if($this->isEditable()): ?>
            <a class="add js-open-editbox hltip" data-target="#editbox-links" href="#"
               ...
               title="<?php \MapasCulturais\i::esc_attr_e('insira links complementares com mais informações que julgue necessárias para demonstrar suas experiências, obras e afins - opcional'); ?>">
            </a>
        <?php endif; ?>
