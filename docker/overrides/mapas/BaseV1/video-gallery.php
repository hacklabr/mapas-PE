...
<?php if($this->isEditable()): ?>
    <p class="gallery-footer" ng-non-bindable>
        <a class="btn btn-default add js-open-editbox hltip"  title="<?php \MapasCulturais\i::esc_attr_e("insira links, preferencialmente do Youtube ou Vimeo, para demonstrar suas experiências, obras e afins - opcional
");?> "href="#"
