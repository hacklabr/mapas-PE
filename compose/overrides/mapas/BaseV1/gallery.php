...
<?php if ($this->isEditable() || $gallery): ?>
    ...
    <?php if($this->isEditable()): ?>
        <p class="gallery-footer">
             ...
             <a class="btn btn-default add js-open-editbox hltip" title="<?php \MapasCulturais\i::esc_attr_e("insira arquivos de fotos nos formatos JPEG ou PNG, em até 8 MB, para demonstrar suas experiências, obras e afins - opcional");?>"data-target="#editbox-gallery-image" href="#"><?php \MapasCulturais\i::_e("Adicionar imagem");?></a>
